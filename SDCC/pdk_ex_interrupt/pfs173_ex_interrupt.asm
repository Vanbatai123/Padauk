...
;	delay.h: 95: }
	ret
;	pfs173_ex_interrupt.c: 8: uint8_t _sdcc_external_startup(void)
;	-----------------------------------------
;	 function _sdcc_external_startup
;	-----------------------------------------
__sdcc_external_startup:
;	pfs173_ex_interrupt.c: 10: ROP = ROP_INT_SRC_PB5;
	mov	a, #0x02
	mov.io	__rop, a
;	pfs173_ex_interrupt.c: 11: EASY_PDK_INIT_SYSCLOCK_8MHZ();		  //use 8MHz sysclock
	mov	a, #0x34
	mov.io	__clkmd, a
;	pfs173_ex_interrupt.c: 12: EASY_PDK_CALIBRATE_IHRC(F_CPU, 5000); //tune SYSCLK to 8MHz @ 4.000V
	and	a, #'R'                        
	and	a, #'C'                        
	and	a, #((1))          
	and	a, #((8000000))     
	...
	and	a, #((5000)>>8)  
	and	a, #((0x0B))           
;	pfs173_ex_interrupt.c: 13: return 0;							  //perform normal initialization
;	pfs173_ex_interrupt.c: 14: }
	ret	#0x00
;	pfs173_ex_interrupt.c: 16: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	pfs173_ex_interrupt.c: 18: setb(PBC, 4);
	set1.io	__pbc, #4
;	pfs173_ex_interrupt.c: 19: setb(PBDIER, 5);
	set1.io	__pbdier, #5
;	pfs173_ex_interrupt.c: 20: setb(PBPH, 5);
	set1.io	__pbph, #5
;	pfs173_ex_interrupt.c: 23: INTEN = INTEN_PB5;
	mov	a, #0x01
	mov.io	__inten, a
;	pfs173_ex_interrupt.c: 24: INTEGS = INTEGS_PB5_FALLING;
	mov	a, #0x02
	mov.io	__integs, a
;	pfs173_ex_interrupt.c: 26: INTRQ = 0;
	mov	a, #0x00
	mov.io	__intrq, a
;	pfs173_ex_interrupt.c: 27: sei();
	engint
;	pfs173_ex_interrupt.c: 29: while (1)
00102$:
	goto	00102$
;	pfs173_ex_interrupt.c: 37: }
	ret
;	pfs173_ex_interrupt.c: 39: void interrupt(void) __interrupt(0)
;	-----------------------------------------
;	 function interrupt
;	-----------------------------------------
_interrupt:
	...
	mov	a, p
	push	af
;	pfs173_ex_interrupt.c: 41: if (INTRQ & INTRQ_PB5)
	mov.io	a, __intrq
	and	a, #0x01
	cneqsn	a, #0x00
	goto	00103$
;	pfs173_ex_interrupt.c: 43: INTRQ &= ~INTRQ_PB5;
	set0.io	__intrq, #0
;	pfs173_ex_interrupt.c: 45: _delay_ms(300);
	mov	a, #0x3e
...
;	pfs173_ex_interrupt.c: 46: daobit(PB, 4);
	mov	a, #0x10
	xor.io	__pb, a
00103$:
;	pfs173_ex_interrupt.c: 48: }
	pop	af
	mov	p, a
	pop	af
	reti
