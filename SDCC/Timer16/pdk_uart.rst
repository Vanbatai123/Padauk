      ...
      000049                        143 	.ds 2
                                    ...
                                    170 ;	-----------------------------------------
      0003F4                        171 _UART_begin:
                                    172 ;	pdk_uart.c: 9: TM2C = TM2C_CLK_IHRC;						 // Use IHRC -> 16 Mhz
      0003F4 20 57                  173 	mov	a, #0x20
      0003F6 30 01                  174 	mov.io	__tm2c, a
                                    175 ;	pdk_uart.c: 10: TM2S = TM2S_PRESCALE_NONE | TM2S_SCALE_DIV2; // No prescale, scale 2 ~> 8MHz
      0003F8 01 57                  176 	mov	a, #0x01
      0003FA 32 01                  177 	mov.io	__tm2s, a
                                    178 ;	pdk_uart.c: 11: TM2B = 69;									 // Divide by 69 ~> 115942 Hz (apx. 115200)
      0003FC 45 57                  179 	mov	a, #0x45
      0003FE 33 01                  180 	mov.io	__tm2b, a
                                    181 ;	pdk_uart.c: 13: PAC |= (1 << UART_TX_PIN); // Enable TX Pin as output
      000400 91 3F                  182 	set1.io	__pac, #7
                                    183 ;	pdk_uart.c: 15: txdata = 0xD55F;	// Setup 2 stop bits, 0x55 char for autobaud, 1 start bit, 5 stop bits
      000402 5F 57                  184 	mov	a, #0x5f
      000404 0F 17                  185 	mov	_txdata+0, a
      000406 D5 57                  186 	mov	a, #0xd5
      000408 10 17                  187 	mov	_txdata+1, a
                                    188 ;	pdk_uart.c: 16: INTEN |= INTEN_TM2; // Enable TM2 interrupt, send out initial stop bits and autobaud char
      00040A 04 3F                  189 	set1.io	__inten, #6
                                    190 ;	pdk_uart.c: 17: }
      00040C 7A 00                  191 	ret
                                    192 ;	pdk_uart.c: 20: void TIM2_interrupt()
                                    193 ;	-----------------------------------------
                                    194 ;	 function TIM2_interrupt
                                    195 ;	-----------------------------------------
      00040E                        196 _TIM2_interrupt:
                                    197 ;	pdk_uart.c: 22: if (txdata)
      00040E 0F 1F                  198 	mov	a, _txdata+0
      000410 10 1D                  199 	or	a, _txdata+1
      000412 00 53                  200 	cneqsn	a, #0x00
      000414 16 62                  201 	goto	00106$
                                    202 ;	pdk_uart.c: 24: if (txdata & 0x01)			 // Check bit (1/0) for sending
      000416 10 1F                  203 	mov	a, _txdata+1
      000418 00 17                  204 	mov	p, a
      00041A 0F 1F                  205 	mov	a, _txdata+0
      00041C 01 54                  206 	and	a, #0x01
      00041E 00 53                  207 	cneqsn	a, #0x00
      000420 13 62                  208 	goto	00102$
                                    209 ;	pdk_uart.c: 25: setb(PA, UART_TX_PIN); // Send 1 on TX Pin
      000422 90 3F                  210 	set1.io	__pa, #7
      000424 14 62                  211 	goto	00103$
      000426                        212 00102$:
                                    213 ;	pdk_uart.c: 27: clrb(PA, UART_TX_PIN); // Send 0 on TX Pin
      000426 90 3B                  214 	set0.io	__pa, #7
      000428                        215 00103$:
                                    216 ;	pdk_uart.c: 28: txdata >>= 1;				 // Shift txdata
      000428 10 2A                  217 	sr	_txdata+1
      00042A 0F 2C                  218 	src	_txdata+0
      00042C                        219 00106$:
                                    220 ;	pdk_uart.c: 30: }
      00042C 7A 00                  221 	ret
      ...
      00042E                        228 00101$:
      00042E 0F 1F                  229 	mov	a, _txdata+0
      000430 10 1D                  230 	or	a, _txdata+1
      000432 00 52                  231 	ceqsn	a, #0x00
      000434 17 62                  232 	goto	00101$
                                    233 ;	pdk_uart.c: 36: INTEN &= ~INTEN_TM2;	   // Disable TM2 (setup of 16 bit value txdata is non atomic)
      000436 04 3B                  234 	set0.io	__inten, #6
                                    235 ;	pdk_uart.c: 37: txdata = (c << 1) | 0x200; // Setup txdata with start and stop bit
      000438 4A 1F                  236 	mov	a, _putChar_PARM_1+1
      00043A 00 17                  237 	mov	p, a
      00043C 49 1F                  238 	mov	a, _putChar_PARM_1+0
      00043E 6B 00                  239 	sl	a
      000440 00 2D                  240 	slc	p
      000442 80 4C                  241 	set1	p, #1
      000444 0F 17                  242 	mov	_txdata+0, a
      000446 00 1F                  243 	mov	a, p
      000448 10 17                  244 	mov	_txdata+1, a
                                    245 ;	pdk_uart.c: 38: INTEN |= INTEN_TM2;		   // Enable TM2
      00044A 04 3F                  246 	set1.io	__inten, #6
                                    247 ;	pdk_uart.c: 39: return (c);
      00044C 4A 1F                  248 	mov	a, _putChar_PARM_1+1
      00044E 00 17                  249 	mov	p, a
      000450 49 1F                  250 	mov	a, _putChar_PARM_1+0
                                    251 ;	pdk_uart.c: 40: }
      000452 7A 00                  252 	ret
                                    253 	.area CODE
                                    254 	.area CONST
                                    255 	.area CABS (ABS)
