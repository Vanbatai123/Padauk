...
;	delay.h: 95: }
	ret
;	timer16.c: 26: unsigned char _sdcc_external_startup(void)
;	-----------------------------------------
;	 function _sdcc_external_startup
;	-----------------------------------------
__sdcc_external_startup:
;	timer16.c: 28: EASY_PDK_INIT_SYSCLOCK_8MHZ();        //use 8MHz sysclock
	mov	a, #0x34
	mov	__clkmd, a
;	timer16.c: 29: EASY_PDK_CALIBRATE_IHRC(F_CPU, 5000); //tune SYSCLK to 8MHz @ 4.000V
	and	a, #'R'                        
	and	a, #'C'                        
	and	a, #((1))          
	and	a, #((8000000))     
	...
	and	a, #((5000)>>8)  
	and	a, #((0x0B))           
;	timer16.c: 30: return 0;                             //perform normal initialization
;	timer16.c: 31: }
	ret	#0x00
;	timer16.c: 33: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	timer16.c: 36: setb(PBC, 4);
	set1	__pbc, #4
;	timer16.c: 37: while (1)
00102$:
;	timer16.c: 39: setb(PB, 4);
	set1	__pb, #4
;	timer16.c: 40: _delay_ms(1000);
	mov	a, #0x29
...
;	timer16.c: 41: clrb(PB, 4);
	set0	__pb, #4
;	timer16.c: 42: _delay_ms(1000);
	mov	a, #0x29
	mov	__delay_loop_32_PARM_1+0, a
	mov	a, #0x2c
	mov	__delay_loop_32_PARM_1+1, a
