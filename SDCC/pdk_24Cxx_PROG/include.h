...
#define setb(reg, bit) 		__asm__("set1 "_ASMV(reg)", #"_ASMD(bit)"\n")
#define clrb(reg, bit) 		__asm__("set0 "_ASMV(reg)", #"_ASMD(bit)"\n")
...
#define sei()        __asm__("engint\n")
#define cli()        __asm__("disgint\n")
