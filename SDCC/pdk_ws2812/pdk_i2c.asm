...
;	pdk_i2c.c: 130: }
	ret
;	pdk_i2c.c: 132: void I2C_writeBuffer(uint8_t *data, uint8_t len)
;	-----------------------------------------
;	 function I2C_writeBuffer
;	-----------------------------------------
_I2C_writeBuffer:
;	pdk_i2c.c: 134: uint8_t i = 0;
	clear	_I2C_writeBuffer_sloc3_1_0+0
00103$:
;	pdk_i2c.c: 135: for (; i < len; ++i)
	mov	a, _I2C_writeBuffer_sloc3_1_0+0
	sub	a, _I2C_writeBuffer_PARM_2+0
	t1sn.io	f, c
	goto	00105$
;	pdk_i2c.c: 137: I2C_write(data[i]);
...
;	pdk_i2c.c: 139: }
	ret
;	pdk_i2c.c: 141: void I2C_endTransmission(void)
;	-----------------------------------------
;	 function I2C_endTransmission
;	-----------------------------------------
_I2C_endTransmission:
;	pdk_i2c.c: 145: for (i = 0; i < txBufferLength; ++i)
...
00103$:
	...
	t1sn.io	f, c
	goto	00101$
;	pdk_i2c.c: 148: I2C_write_t(txBuffer[i]);
	mov	a, #(_txBuffer + 0)
...
;	pdk_i2c.c: 145: for (i = 0; i < txBufferLength; ++i)
	...
	goto	00103$
00101$:
;	pdk_i2c.c: 152: I2C_stop();
	goto	_I2C_stop
;	pdk_i2c.c: 153: }
	ret
;	pdk_i2c.c: 155: void I2C_requestFrom(uint8_t addr, uint8_t len)
;	-----------------------------------------
;	 function I2C_requestFrom
;	-----------------------------------------
_I2C_requestFrom:
;	pdk_i2c.c: 158: rxBufferLength = len;
	mov	a, _I2C_requestFrom_PARM_2+0
	mov	_rxBufferLength+0, a
;	pdk_i2c.c: 159: rxBufferIndex = 0;
	clear	_rxBufferIndex+0
;	pdk_i2c.c: 162: I2C_start();
	call	_I2C_start
;	pdk_i2c.c: 165: I2C_write_t((addr << 1) | I2C_READ);
	mov	a, _I2C_requestFrom_PARM_1+0
	sl	a
	or	a, #0x01
	mov	_I2C_write_t_PARM_1+0, a
	call	_I2C_write_t
;	pdk_i2c.c: 168: for (i = 0; i < rxBufferLength - 1; i++)
...
00103$:
	...
	t1sn.io	f, c
	goto	00101$
;	pdk_i2c.c: 170: rxBuffer[i] = I2C_read_t(ACK);
	mov	a, #(_rxBuffer + 0)
...
;	pdk_i2c.c: 168: for (i = 0; i < rxBufferLength - 1; i++)
	...
	goto	00103$
00101$:
;	pdk_i2c.c: 173: rxBuffer[rxBufferLength - 1] = I2C_read_t(NACK);
	mov	a, _rxBufferLength+0
	sub	a, #0x01
	add	a, #(_rxBuffer + 0)
	...
	xch	a, p
	idxm	p, a
;	pdk_i2c.c: 176: I2C_stop();
	goto	_I2C_stop
;	pdk_i2c.c: 177: }
	ret
;	pdk_i2c.c: 179: int8_t I2C_read(void)
;	-----------------------------------------
;	 function I2C_read
;	-----------------------------------------
_I2C_read:
;	pdk_i2c.c: 181: int8_t value = 5;
	mov	a, #0x05
	mov	p, a
;	pdk_i2c.c: 183: if (rxBufferIndex < rxBufferLength)
	mov	a, _rxBufferIndex+0
	sub	a, _rxBufferLength+0
	t1sn.io	f, c
	goto	00102$
;	pdk_i2c.c: 185: value = rxBuffer[rxBufferIndex];
	mov	a, #(_rxBuffer + 0)
	add	a, _rxBufferIndex+0
	mov	p, a
	idxm	a, p
	mov	p, a
;	pdk_i2c.c: 186: ++rxBufferIndex;
	inc	_rxBufferIndex+0
00102$:
;	pdk_i2c.c: 188: return value;
	mov	a, p
;	pdk_i2c.c: 189: }
	ret
;	pdk_i2c.c: 190: char I2C_available(void)
;	-----------------------------------------
;	 function I2C_available
;	-----------------------------------------
_I2C_available:
;	pdk_i2c.c: 192: return rxBufferLength - rxBufferIndex;
	mov	a, _rxBufferLength+0
	sub	a, _rxBufferIndex+0
;	pdk_i2c.c: 193: }
	ret
;	pdk_i2c.c: 194: void I2C_begin(void)
;	-----------------------------------------
;	 function I2C_begin
;	-----------------------------------------
_I2C_begin:
;	pdk_i2c.c: 196: I2C_PxC |= (1 << I2C_SDA);
	set1.io	__pbc, #3
;	pdk_i2c.c: 197: I2C_PxC |= (1 << I2C_SCL);
	set1.io	__pbc, #2
;	pdk_i2c.c: 198: }
	ret
	.area CODE
