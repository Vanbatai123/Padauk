...
;--------------------------------------------------------
	...
	.globl _softuart_putchar
	.globl _softuart_init
...
;	delay.h: 95: }
	ret
;	pfs173_uart.c: 8: uint8_t _sdcc_external_startup(void)
;	-----------------------------------------
;	 function _sdcc_external_startup
;	-----------------------------------------
__sdcc_external_startup:
;	pfs173_uart.c: 10: EASY_PDK_INIT_SYSCLOCK_8MHZ();		  //use 8MHz sysclock
	mov	a, #0x34
	mov	__clkmd, a
;	pfs173_uart.c: 11: EASY_PDK_CALIBRATE_IHRC(F_CPU, 5000); //tune SYSCLK to 8MHz @ 4.000V
	and	a, #'R'                        
	and	a, #'C'                        
	and	a, #((1))          
	and	a, #((8000000))     
	...
	and	a, #((5000)>>8)  
	and	a, #((0x0B))           
;	pfs173_uart.c: 12: return 0;							  //perform normal initialization
;	pfs173_uart.c: 13: }
	ret	#0x00
;	pfs173_uart.c: 15: int main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	pfs173_uart.c: 17: softuart_init();
	call	_softuart_init
;	pfs173_uart.c: 19: while (1)
00102$:
;	pfs173_uart.c: 21: softuart_putchar('[');
	mov	a, #0x5b
	mov	_softuart_putchar_PARM_1+0, a
	call	_softuart_putchar
;	pfs173_uart.c: 22: softuart_putchar('\n');
	mov	a, #0x0a
	mov	_softuart_putchar_PARM_1+0, a
	call	_softuart_putchar
;	pfs173_uart.c: 23: _delay_ms(1000);
	mov	a, #0x29
